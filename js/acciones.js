...
document.addEventListener("deviceready",function(){
	...
	audio.preloadAudio('b1','audio/A.mp3',function(){},function(msg){alert("Error "+msg);});
	audio.preloadAudio('b2','audio/X.mp3',function(){},function(msg){alert("Error "+msg);});
	audio.preloadAudio('b3','audio/Y.mp3',function(){},function(msg){alert("Error "+msg);});
	audio.preloadAudio('b4','audio/Z.mp3',function(){},function(msg){alert("Error "+msg);});
